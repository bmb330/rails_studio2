...
describe "A user" do
	...
	it "requires the password to mathc the password confirmation" do
	...
	it "does not requrie a password when updating" do
...
describe "authenticate" do
	...
	it "returns non-ture value if the email does not match" do
		expect(User.authenticate("nomatch", @user.password)).not_to eq(true)
	end

	it "returns non-true value if the password does not mathc" do
